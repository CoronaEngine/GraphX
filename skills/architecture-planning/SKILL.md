...
2. Build `WORKING_SET.md` progressively: documents, code entry points, tests, decisions, explorations, and concrete unknowns.
...
7. Run task validation and transition with `PLAN` only when the plan and working set are complete.
